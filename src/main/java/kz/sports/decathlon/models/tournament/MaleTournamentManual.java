...
public class MaleTournamentManual extends AbstractTournament {
    ...
    ArrayList<Event> getEventsDefinition() {
        ...
        events.add(new Event("100 m", new EventParams("25.4347", "18", "1.81", "0.24"), EventTypeEnum.TRACK));
        ...
        events.add(new Event("400 m", new EventParams("1.53775", "82", "1.81", "0.14"), EventTypeEnum.TRACK));
        events.add(new Event("110 m hurdles", new EventParams("5.74352", "28.5", "1.92", "0.24"), EventTypeEnum.TRACK));
